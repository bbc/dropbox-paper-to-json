...
function dbpMdToJson(options){
    ...
    var paper = new dropboxpaper({accessToken: options.accessToken});
    ...
    paper.downloadDoc({doc_id: options.dbp_doc_id, export_format: 'markdown', filename: dropBoxPaperMarkdownFileName})
